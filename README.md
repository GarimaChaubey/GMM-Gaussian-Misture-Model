...
✔ It models **overlapping clusters**  
✔ It supports **arbitrary covariance** → elliptical shapes  
✔ It gives **probabilities**, not just labels  
...
- **Σ (covariance):** shape, size, orientation  
...
These labels \(z_i\) are **not observed** → they are *latent*.
...
- γᵢₖ = “point i belongs to cluster k with probability γᵢₖ”
